...
# ---------------------------------------------------------------------------
# RECORD "Social 001" — first record in a THIRD numbering sequence.
#
# Blog NNN    -> an article on /blog
# Insight NNN -> a Financial Market Insight newsletter on /insights
# Social NNN  -> standalone social content that is NOT a repost of a blog or
#                insight. This piece (a Myth vs. Fact educational graphic
#                turned into a narrated video) originates on social and has
#                no website article behind it, so it cannot be a "-IG" sibling
#                of anything -- it needs its own base number.
#
# Platform siblings still work the same way: Social 001-IG, Social 001-FB,
# Social 001-LI, Social 001-X. Because this one was published to Instagram
# first, it is recorded directly as Social 001-IG.
# ---------------------------------------------------------------------------
SOCIAL_EDUCATIONAL_DISCLOSURE = (
    "This content is provided for informational and educational purposes only and should not be "
    "construed as investment, tax, or legal advice. Investing involves risk, including the possible "
    "loss of principal. Past performance is not indicative of future results."
)

record_15 = {
    "record_id": "Social 001-IG",
    "post_title": "Myth vs. Fact: The Truth About Investing (Instagram reel)",
    "status": "Published",
    ...
    "media_filenames": (
        "MythvsFactnarrated_WithMusic.mp4 (28s, 1080x1424, H.264/AAC) -- built from the static "
    ...
    "caption_paragraphs": [
        ...
        "FACT: Investing is for anyone who wants to build a better future. You don't need a lot of "
        "money to start — you just need a plan and consistency.",
        "Thanks to today's tools and resources, you can start with small amounts and grow over time:",
        "☑ Start small — even small contributions can make a difference.",
        "☑ Grow over time — compound growth rewards patience and consistency.",
        "☑ Reach your goals — investing helps turn today's actions into tomorrow's opportunities.",
        "Focus on the plan. Stay disciplined. Think long-term.",
        "[Narration audio, spoken in the video:] Here's a common myth: that investing is only for the "
        "wealthy. The fact? Investing is for anyone who wants to build a better future. You don't need "
        "a lot of money to start — you need a plan and consistency. Start small, stay disciplined, and "
        "think long-term. Informational and educational only. Investing involves risk, including "
    ...
    "sources": [
        "No external sources cited -- this is general investor-education content making no factual, "
        "statistical, or performance claims requiring substantiation. Nothing in the piece references "
        "a specific security, sector, strategy, return figure, or time period.",
        "Music: royalty-free instrumental from Pixabay (cleared for commercial use, no attribution "
        "required). Voiceover: ElevenLabs synthetic voice, generated by VEM.",
    ],
    ...
    "revision_history": [
        ("1", "7/23/2026", "Marketing Record created at time of publish -- first record in the Social sequence"),
    ],

    "notes": (
        "First record under the new 'Social NNN' sequence, for standalone social content with no "
        "website article behind it (see the convention note above this record in the source file). "
        "\n\n"
        "DISCLOSURE PLACEMENT -- FLAGGED FOR REVIEW: the required disclosure appears twice inside the "
        "creative itself (rendered in the navy footer band of the infographic, and spoken aloud at the "
        "end of the narration), but the Instagram CAPTION as posted does not repeat it, and carries no "
        "hashtags. That may be perfectly acceptable since the disclosure travels with the creative on "
        "every view -- but a viewer scrolling a muted feed sees the caption before the video's final "
        "frame. Raised for John Vann to confirm whether caption-level disclosure should be house "
        "standard on social video going forward. Not treated as a defect here, just not assumed away."
        "\n\n"
        "AI DISCLOSURE -- PLATFORM INCONSISTENCY CONFIRMED: the narration is a synthetic ElevenLabs "
        "voice. The identical creative was posted to both Instagram and Facebook on the same day; "
        "Facebook auto-labeled it 'AI content' and Instagram did not (verified against both live "
        "screenshots, social-001-ig.png and social-001-fb.png). So the SAME asset carries an AI "
        "disclosure on one Meta property and none on the other, through no choice of VEM's. Given "
        "that 'AI washing' is a named 2026 SEC exam priority, relying on platform auto-labeling as "
        "the firm's AI disclosure is not a controllable compliance posture. Raised for John Vann: "
        "VEM may want its own affirmative disclosure that travels with the creative, rather than "
        "depending on each platform's labeling behavior. Same flag applies to the Insight 001 avatar "
        "video records."
        "\n\n"
...
record_16 = {
    "record_id": "Social 001-FB",
    "post_title": "Myth vs. Fact: The Truth About Investing (Facebook reel)",
    "status": "Published",
    "date_created": "7/23/2026",
    "publish_date": "7/23/2026",
    "archive_date": "TBD",
    ...
    "caption_paragraphs": [
        ...
        "verbatim caption. The Facebook reel view captured in the screenshot displays the post header "
        "('Vann Equity Management · AI content · Original audio') rather than the expanded caption "
        "body, so the caption is recorded once, on the IG record, rather than transcribed twice from "
        "a partial view.",
        "MYTH: Investing is only for the wealthy.",
        "FACT: Investing is for anyone who wants to build a better future. You don't need a lot of "
        "money to start — you just need a plan and consistency.",
    ...
    "sources": [
        ...
        "statistical, or performance claims requiring substantiation.",
        "Music: royalty-free instrumental from Pixabay (cleared for commercial use). Voiceover: "
        "ElevenLabs synthetic voice, generated by VEM.",
    ],
    ...
    "notes": (
        "Facebook sibling of Social 001-IG -- same creative, same day, separate record per the "
        "multi-channel convention."
        "\n\n"
        "AI LABELING: Facebook auto-labeled this post 'AI content'; the identical post on Instagram "
        "was not labeled. See the AI disclosure note on Social 001-IG -- the inconsistency is the "
        "point, and it is a platform behavior VEM does not control."
        "\n\n"
        "Published URL is TBD pending the direct post permalink; the post is confirmed live via "
        "screenshot in the interim."
    ),
